...
const pages = [
  ...
  { url: '/uk-degree-classification-calculator', priority: '0.9', freq: 'monthly' },
  { url: '/ucas-points-calculator', priority: '0.9', freq: 'monthly' },
  { url: '/btec-ucas-points-calculator', priority: '0.8', freq: 'monthly' },
  { url: '/a-level-grade-calculator', priority: '0.9', freq: 'monthly' },
  { url: '/uk-student-loan-calculator', priority: '0.9', freq: 'monthly' },
