  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Free online tools for students: GPA calculator, MDCAT, ECAT, NUST, FAST aggregates, UCAS points, BTEC calculator, UK degree classification and more. No signup needed." />
        <meta property="og:title" content="ScholarTools — Free Online Tools for Students" />
        <meta property="og:description" content="30+ free tools for students. GPA calculator, MDCAT, ECAT, NUST, FAST, UCAS points, BTEC calculator, FBR tax and more. All free, no signup." />
